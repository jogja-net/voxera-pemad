    ...
    <footer id="contact" className="bg-ink px-4 pt-[72px] pb-10 text-line sm:px-6 lg:px-10">
      <div className="mx-auto grid max-w-[1240px] grid-cols-[repeat(auto-fit,minmax(min(240px,100%),1fr))] gap-12">
        <div className="flex flex-col gap-3">
          ...
          <span className="text-[15px] leading-6 text-faint">
            {dict.footer.tagline}
          </span>
        </div>
        ...
        <div className="flex flex-col gap-3.5">
          ...
          {quickLinks.map((link) => (
            <a
              key={link.label}
              href={link.href}
              className="text-[15px] text-line transition-colors hover:text-brand-light"
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="flex flex-col gap-3.5">
          ...
          <span className="text-[15px] leading-6 text-line">
